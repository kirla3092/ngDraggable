  ...
  .directive('ngDrag', ['$rootScope', '$parse', '$document', '$window', 'ngDraggable', function($rootScope, $parse, $document, $window, ngDraggable) {
    return {
      ...
      link: function(scope, element, attrs) {
        ...
        var _topAnchor = attrs.ngTopAnchor || null;
        var _leftAnchor = attrs.ngLeftAnchor || null;
        ...
        var toggleListeners = function(enable) {
          ...
          scope.$watch(attrs.ngTopAnchor, onTopAnchor);
          scope.$watch(attrs.ngLeftAnchor, onLeftAnchor);
        ...
        var onlongpress = function(evt) {
          ...
          _mry = _my - offset.top;
					...
					if (_topAnchor !== null) {
						if(_topAnchor === "center"){
							_ty = _my - element.centerY - $window.pageYOffset;
						} else {
							_ty = _my - _topAnchor - $window.pageYOffset;
						}
					}else {
						_ty = _my - _mry - $window.pageYOffset;
					}
					if (_leftAnchor !== null) {
						if(_leftAnchor === "center"){
							_tx = _mx - element.centerX - $window.pageXOffset;
						} else {
							_tx = _mx - _leftAnchor - $window.pageXOffset;
						}
					}else {
						_tx = _mx - _mrx - $window.pageXOffset;
					}
        ...
        var onmove = function(evt) {
          ...
          _my = ngDraggable.inputEvent(evt).pageY; //ngDraggable.getEventProp(evt, 'pageY');
					...
					if (_topAnchor !== null) {
						if(_topAnchor === "center"){
							...
							_ty = _my - _topAnchor - _dragOffset.top;
						}
          }else {
          ...
          if (_leftAnchor !== null) {
						if(_leftAnchor === "center"){
							...
							_tx = _mx - _leftAnchor - _dragOffset.left;
						}
          }else {
